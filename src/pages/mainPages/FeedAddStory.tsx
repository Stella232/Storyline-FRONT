...
export default function FeedAddStory({ hide }: { hide: boolean }) {
  ...
  async function handleAddStory(formData: PostModel) {
    ...
    try {
      ...
      const newPost = { ...formData, photo: photoUrl, authorId: user?._id }
  ...
  return (
    <article className="md:h-4/5 sm:w-full sm:px-4 py-12 mx-auto">
